 ...
 *   2. Run: node scripts/generate-test-messages.mjs [options]
 *
 * Options:
...
async function getUsernames(homePath) {
...
async function getUserConfig(homePath, username) {
...
function generateTimestamp(index, totalCount, daysSpread) {
